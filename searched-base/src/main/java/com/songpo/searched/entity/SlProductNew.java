...
@Table(name = "sl_product_new")
public class SlProductNew implements Serializable {
    /**
     * 商品id（varchar类型）
     */
    @Id
    ...
    /**
     * 获取活动类型 0无促销，1拼团，2限时折扣 3.新人专享
     *
     * @return activity_type - 活动类型 0无促销，1拼团，2限时折扣 3.新人专享
     */
    ...
    /**
     * 设置活动类型 0无促销，1拼团，2限时折扣 3.新人专享
     *
     * @param activityType 活动类型 0无促销，1拼团，2限时折扣 3.新人专享
     */
    ...
    /**
     * 获取售卖区域id 物流模板id  ns_order_shipping_fee 表id
     *
     * @return shipping_fee_id - 售卖区域id 物流模板id  ns_order_shipping_fee 表id
     */
    ...
    /**
     * 设置售卖区域id 物流模板id  ns_order_shipping_fee 表id
     *
     * @param shippingFeeId 售卖区域id 物流模板id  ns_order_shipping_fee 表id
     */
    ...
    public String toString() {
        ...
        sb.append(", shippingFeeId=").append(shippingFeeId);
