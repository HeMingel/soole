...
public class ApplicationController {
    ...
    public BusinessMessage<JSONObject> agentApplication(SlAgentApplication agent, MultipartFile idCardHand) {
        ...
        if (StringUtils.isBlank(agent.getProvince())) {
            ...
            message.setMsg("城市为空");
        } else if (StringUtils.isBlank(agent.getCounty())) {
            message.setMsg("区县为空");
        } else if (StringUtils.isBlank(agent.getTown())) {
            message.setMsg("乡镇为空");
        } else if (StringUtils.isBlank(agent.getStreet())) {
            message.setMsg("街道为空");
        } else if (StringUtils.isBlank(agent.getOtherAddress())) {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "companyName", value = "企业名称", paramType = "form"),
            @ApiImplicitParam(name = "phone", value = "电话", paramType = "form", required = true),
    ...
    public BusinessMessage<JSONObject> businessApplication(SlBusinessApplication business, MultipartFile idCardHand) {
        ...
        if (StringUtils.isBlank(business.getProvince())) {
            ...
            message.setMsg("城市为空");
        } else if (StringUtils.isBlank(business.getCounty())) {
            message.setMsg("区县为空");
