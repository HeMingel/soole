        ...
        try {
            if (null != mapScAmount && mapScAmount.size()>0){
                if (null != mapAmount && mapAmount.size()>0){
                    ...
                    mapScAmount.put("allReleaseAmount",Double.parseDouble(mapAmount.get("amount").toString())+(Double.parseDouble(mapAmount.get("allReleaseAmount")==null?"0":mapAmount.get("allReleaseAmount")+""))+"");
                    mapScAmount.put("allScAmount",Double.parseDouble(mapScAmount.get("allScAmount")==null?"0":mapScAmount.get("allScAmount").toString()));
                    mapScAmount.put("aAmount",Double.parseDouble(mapScAmount.get("aAmount")==null?"0":mapScAmount.get("aAmount").toString()));
                    mapScAmount.put("eScAmount",Double.parseDouble(mapScAmount.get("eScAmount")==null?"0":mapScAmount.get("eScAmount").toString()));
                    mapScAmount.put("aReleaseAmount",Double.parseDouble(mapScAmount.get("aReleaseAmount")==null?"0":mapScAmount.get("aReleaseAmount").toString()));
                    mapScAmount.put("dScAmount",Double.parseDouble(mapScAmount.get("dScAmount")==null?"0":mapScAmount.get("dScAmount").toString()));
                    mapScAmount.put("eAmount",Double.parseDouble(mapScAmount.get("eAmount")==null?"0":mapScAmount.get("eAmount").toString()));
                    mapScAmount.put("cScAmount",Double.parseDouble(mapScAmount.get("cScAmount")==null?"0":mapScAmount.get("cScAmount").toString()));
                    mapScAmount.put("dAmount",Double.parseDouble(mapScAmount.get("dAmount")==null?"0":mapScAmount.get("dAmount").toString()));
                    mapScAmount.put("cAmount",Double.parseDouble(mapScAmount.get("cAmount")==null?"0":mapScAmount.get("cAmount").toString()));
                    mapScAmount.put("allAmount",Double.parseDouble(mapScAmount.get("allAmount")==null?"0":mapScAmount.get("allAmount").toString()));
                    mapScAmount.put("bReleaseBmount",Double.parseDouble(mapScAmount.get("bReleaseBmount")==null?"0":mapScAmount.get("bReleaseBmount").toString()));
                    mapScAmount.put("bScAmount",Double.parseDouble(mapScAmount.get("bScAmount")==null?"0":mapScAmount.get("bScAmount").toString()));
                    mapScAmount.put("bAmount",Double.parseDouble(mapScAmount.get("bAmount")==null?"0":mapScAmount.get("bAmount").toString()));
                    mapScAmount.put("eReleaseBmount",Double.parseDouble(mapScAmount.get("eReleaseBmount")==null?"0":mapScAmount.get("eReleaseBmount").toString()));
                    mapScAmount.put("cReleaseBmount",Double.parseDouble(mapScAmount.get("cReleaseBmount")==null?"0":mapScAmount.get("cReleaseBmount").toString()));
                    mapScAmount.put("aScAmount",Double.parseDouble(mapScAmount.get("aScAmount")==null?"0":mapScAmount.get("aScAmount").toString()));
                    mapScAmount.put("dReleaseBmount",Double.parseDouble(mapScAmount.get("dReleaseBmount")==null?"0":mapScAmount.get("dReleaseBmount").toString()));
                    ...
                    mapScAmount.put("aScAmount",Double.parseDouble(mapScAmount.get("aScAmount")==null?"0":mapScAmount.get("aScAmount").toString()));
                    mapScAmount.put("dReleaseBmount",Double.parseDouble(mapScAmount.get("dReleaseBmount")==null?"0":mapScAmount.get("dReleaseBmount").toString()));
                    mapScAmount.put("allReleaseAmount",Double.parseDouble(mapScAmount.get("allReleaseAmount")==null?"0":mapScAmount.get("allReleaseAmount").toString()));
                    message.setData(mapScAmount);
                }
            }else {
                if (null != mapAmount && mapAmount.size()>0){
